...
<script crossorigin="anonymous" defer="defer" type="application/javascript" src="https://github.githubassets.com/assets/code-menu-614feb194539.js"></script>
  ...
  <meta name="request-id" content="60F2:0EB8:C4EF1E:C78D04:6601E6E9" data-pjax-transient="true"/><meta name="html-safe-nonce" content="58f7035a552fa28f79b2ca324b9f23437c544ae00b4543987707d40c69435275" data-pjax-transient="true"/><meta name="visitor-payload" content="eyJyZWZlcnJlciI6IiIsInJlcXVlc3RfaWQiOiI2MEYyOjBFQjg6QzRFRjFFOkM3OEQwNDo2NjAxRTZFOSIsInZpc2l0b3JfaWQiOiI0MzY5MTM1ODQ2NzAwNDc2MTM2IiwicmVnaW9uX2VkZ2UiOiJmcmEiLCJyZWdpb25fcmVuZGVyIjoiZnJhIn0=" data-pjax-transient="true"/><meta name="visitor-hmac" content="e92b09bdf9b70d07b0f3c8a133ad438ffce991d0344c0f110bd060e88254e68e" data-pjax-transient="true"/>
  ...
  <div class="Overlay-headerContentWrap">
    ...
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <scrollable-region data-labelled-by="feedback-dialog-title">
        <div data-view-component="true" class="Overlay-body">        <!-- '"` --><!-- </textarea></xmp> --></option></form><form id="code-search-feedback-form" data-turbo="false" action="/search/feedback" accept-charset="UTF-8" method="post"><input type="hidden" data-csrf="true" name="authenticity_token" value="P7fZ8HLYXB2Fryg+XWQMefLrcNKm77wasbE5Ww9LDRJ2Tg8dYw07+fzb4J0KlL3rOY+0RvI3GTRibEzlZKnIhA==" />
  ...
  <div class="Overlay-headerContentWrap">
    ...
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <scrollable-region data-labelled-by="custom-scopes-dialog-title">
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form id="custom-scopes-dialog-form" data-turbo="false" action="/search/custom_scopes" accept-charset="UTF-8" method="post"><input type="hidden" data-csrf="true" name="authenticity_token" value="uMdSu+qkKqWLNGYVKqiV7WtTh5LNDvqk9t2M9ZRdgnXq9wwKAJZbzKt+Wp5r5EvH3ymuByRstfUI+J4loCbb1w==" />
          ...
          <div class="form-group">
            ...
            <auto-check src="/search/custom_scopes/check_name" required>
              <input
                ...
                required
                maxlength="50">
              <input type="hidden" data-csrf="true" value="ly5bEClFO2h5p8WTrkqbUPHU42XWnLBU9UOuaXNYXeczOWgpaPSQM0XGpqWDVCUoJcSlXgbUczzSXRZnx4S+ow==" />
            </auto-check>
          </div>
...
</qbsearch-input><input type="hidden" data-csrf="true" class="js-data-jump-to-suggestions-path-csrf" value="siSQpsntlbNeMR9S02gv8LwU6xPNVnzqyuze3wN50OjXRem+wJHLvFIVJEyCe7JvqLqP2IDk+szL3j9K/xIfZQ==" />
...
data-styled.g103[id="UnderlineNav__NavigationList-sc-1jfr31k-0"]{content:"bPgibo,"}/*!sc*/
        ...
        <input type="hidden" data-csrf="true" value="7FGbV0X1mzTr7Rgcfsh4Hv20rNnNmhm6rhOtInROd72doB5RTg4YhhFOf2BQaWK8WMfwOb5bI8GRQgeRR4o9Yg==" />
</div>
